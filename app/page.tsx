...
const STATS = [
  ...
  { value: "19%", label: "slower — AI tools actually slow experienced devs", source: "METR Study (RCT)" },
...
const PIPELINE_STEPS = [
  {
    icon: "Ã°ÂÂÂ¯", title: "Spec Engine", desc: "Force structured requirements before AI writes a single line. No more 'build me an app' prompts.",
  ...
  {
    icon: "⚡", title: "Generate", desc: "Use any AI model — Claude, GPT, Gemini, Cursor, local models. We're the orchestrator, not the generator.",
    color: "#8b5cf6", detail: "Your spec becomes a JSON contract. Paste it into any AI. The model doesn't guess — it follows your spec.",
  },
  {
    icon: "Ã°ÂÂÂ¡Ã¯Â¸Â", title: "Security Scan", desc: "25+ OWASP-aligned rules catch what every other platform misses. Hardcoded secrets, SQL injection, XSS, SSRF.",
  ...
  {
    icon: "Ã°ÂÂÂ", title: "Code Review", desc: "Senior-developer-level automated review. Logic errors, code smell, tech debt, N+1 queries, anti-patterns.",
    color: "#ec4899", detail: "30+ rules across 7 categories. Code metrics dashboard. The 91% review bottleneck — eliminated.",
  },
  {
    icon: "Ã°ÂÂÂ", title: "Ship Gate", desc: "Overall score. Pre-ship checklist. Either 'CLEARED FOR DEPLOYMENT' or 'DO NOT SHIP'. No middle ground.",
      ...
      <section className="px-6 pt-20 pb-16">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-block px-4 py-1.5 rounded-full border border-red-500/30 bg-red-500/10 text-red-400 text-xs font-semibold mb-6 tracking-wide">
            100% of vibe-coded apps have security vulnerabilities — Columbia University
          </div>
          ...
          <p className="text-lg text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
            ...
            with a built-in quality pipeline: Spec → Generate → Security Scan → Code Review → Ship Gate.
              ...
              >
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-slate-500 text-lg">{expandedStep === i ? "−" : "+"}</span>
                  </div>
                  {expandedStep === i && (
